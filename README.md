...
The OS — Kişisel İşletim Sistemi
...
⚡ Daily OS
Morning Stack — Özelleştirilebilir sabah ritüeli checklist'i
...
Day Score — Sabah ritüeli + alışkanlık tamamlanma oranından hesaplanan günlük skor
...
Sıfır bağımlılık — sadece React
Depolama
window.storage (Claude Artifacts) → localStorage (yerel)
Her iki ortamda da otomatik çalışır. 700ms debounce ile sessiz otomatik kayıt.
Mimari
...
***Kurulum
# Projeyi klonla
git clone https://github.com/kullanici-adi/the-os.git
cd the-os
